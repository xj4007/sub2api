...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	contentModerationConfigStore := repository.NewContentModerationConfigStore(redisClient)
	contentModerationService := service.NewContentModerationServiceWithRedis(settingRepository, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, proxyRepository, apiKeyAuthCacheInvalidator, emailService, contentModerationConfigStore)
